...
export const KEYMAP_CATALOG: KeymapCatalogEntry[] = [
  ...
  { id: "global.modeCycle", group: "global", defaultBinding: "Mod+E", title: "Cycle editor / split / preview" },
  ...
  { id: "global.toggleHistoryPanel", group: "global", defaultBinding: "", title: "Toggle history panel" },
  ...
  { id: "vim.tabPreviousAlt", group: "vim", defaultBinding: "Shift+H", title: "Previous tab (Shift+H)" },
  { id: "vim.tabNextAlt", group: "vim", defaultBinding: "Shift+L", title: "Next tab (Shift+L)" },
